# <img class="bitum-icon" src="/img/bitum-icons/Harddrive.svg" /> Security

This page provides a list of things you can do to improve your security when working with BITUM, or cryptocurrencies more generally.
...
- **Only run bitumwallet on ticketbuying machine:** bitumd, the consensus daemon, necessarily communicates with a variety of peers on the public internet. Run bitumwallet on a locked-down machine and have it connect to a remote bitumd to minimize traffic going to or from your secure machine.
