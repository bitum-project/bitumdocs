# <img class="bitum-icon" src="/img/bitum-icons/DeleteWallet.svg" /> Deleting Your Wallet 
...
First you need to find the bitumwallet application directory which varies by platform.
