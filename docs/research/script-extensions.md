# <img class="bitum-icon" src="/img/bitum-icons/Code.svg" /> Script Extensions 
...
[^2]: Todd P. [The difficulty of writing consensus critical code: The SIGHASH_SINGLE bug](https://bitum.io/research/todd2014.pdf).
